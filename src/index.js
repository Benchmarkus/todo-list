...
export function submitToDoFormLogic(e) {
    ...
    if (document.getElementById("todo-form").editMode) {
        ...
        const newToDoObject = new ToDo(toDoName, toDoDesc, toDoDuedate, toDoPriority, parentId, toDoId);
        Application.editToDo(parentId, toDoId, newToDoObject)
    } else {
        const newToDoObject = new ToDo(toDoName, toDoDesc, toDoDuedate, toDoPriority, parentId, undefined);
